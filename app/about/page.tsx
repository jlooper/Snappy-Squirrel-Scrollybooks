...
export default function About() {
    return (
      ...
      <p className="text-xl leading-loose">The illustrations in this book are a mixed-media project by Jen. First, she used a gelli plate to create mimeograph-style monoprints using acrylic paint and - when it works - image transfer from various recycled magazines and books. Then, she cuts up the paper to create the collage animals. Photographed in pieces and reassembled in Procreate on an iPad, extras like facial expressions can be added digitally. Below are some photos of the process. Rubber stampd and nature prints, all using repurposed materials, also add to the layers.</p>
      <Image
